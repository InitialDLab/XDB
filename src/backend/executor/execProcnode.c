...
ExecInitNode(Plan *node, EState *estate, int eflags)
{
	...
	switch (nodeTag(node))
	{
		...
		/* online sample join */
		case T_OnlineAgg:
			result = (PlanState *) ExecInitOnlineAgg((OnlineAgg *) node, estate, eflags);
			break;

		case T_OnlineSampleJoin:
			elog(ERROR, "init of OnlineSampleJoin should not be called by dispatcher");
			break;
...
ExecProcNode(PlanState *node)
{
	...
	switch (nodeTag(node))
	{
		...
		/* online sample join */
		case T_OnlineAggState:
			result = ExecOnlineAgg((OnlineAggState *) node);
			break;
...
ExecEndNode(PlanState *node)
{
	...
	switch (nodeTag(node))
	{
		...
		/* online sample join */
		case T_OnlineAggState:
			ExecEndOnlineAgg((OnlineAggState *) node);
			break;
