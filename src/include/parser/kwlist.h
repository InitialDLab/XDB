 ...
 *
 * Derived from kwlist.h of PostgreSQL 9.4.2.
 *
...
PG_KEYWORD("allow_push_down_agg", ALLOW_PUSH_DOWN_AGG, RESERVED_KEYWORD)
PG_KEYWORD("allow_push_down_filter", ALLOW_PUSH_DOWN_FILTER, RESERVED_KEYWORD)
...
PG_KEYWORD("initsample", INITSAMPLE, RESERVED_KEYWORD)
...
PG_KEYWORD("reportinterval", REPORTINTERVAL, RESERVED_KEYWORD)
...
PG_KEYWORD("withtime", WITHTIME, RESERVED_KEYWORD)
