 ...
 *
 * Derived from parsenodes.h of PostgreSQL 9.4.2
 *
...
typedef struct SelectStmt
{
	...
	WithClause *withClause;		/* WITH clause */
	uint32 	   	withTime;		/* with time for the usage of online aggregate */
	uint32		confidence;		/* with confidence for the usage of online aggregate */
	uint32		reportInterval;	/* report interval (in ms) */
	uint32		nInitSamples;	/* number of initial samples for plan selection */
