...
/* OIDs of part of aggregates */
#define PG_AGG_SUM_LOW			2107
#define PG_AGG_SUM_HIGH			2114
#define PG_AGG_COUNT			2803
#define PG_AGG_COUNT_STRICT		2147

#define PG_AGG_IS_SUM(oid)		((oid) >= (PG_AGG_SUM_LOW) && (oid) <= (PG_AGG_SUM_HIGH))
#define PG_AGG_IS_COUNT(oid)	((oid == PG_AGG_COUNT) || (oid == PG_AGG_COUNT_STRICT))
