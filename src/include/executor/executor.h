...
extern TupleTableSlot *ExecProject(ProjectionInfo *projInfo,
			ExprDoneCond *isDone);
extern ExprState *online_ExecInitExpr(Expr *node, 
									  PlanState * parent, 
									  ExprStateEvalFunc scalarVarEvalFunc);
...
/* functions in nodeOnline.c */
extern OnlineAggState *ExecInitOnlineAgg(OnlineAgg *node, EState *estate, int eflags);
extern OnlineSampleJoinState *ExecInitOnlineSampleJoin(OnlineSampleJoin *node, 
