 ...
 *
 * Derived from nbtree.h of PostgreSQL 9.4.2.
 *
...
extern bool _bt_fix_scankey_strategy(ScanKey skey, int16 *indoption);
extern bool _bt_compare_scankey_args_noscandesc(Relation index, ScanKey op, 
			ScanKey leftarg, ScanKey rightarg, bool *result);
...
#define _bt_sample_reset(btsamplestate) \
	do {	\
